...
- Animated GIF and WebP pages play inline. Peek mode (progress-free reading), page image actions, persistent reader progress overlays, AI upscaling, and iOS Live Text are supported where available.
