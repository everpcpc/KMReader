...
- Browse Series, Books, Collections, and Read Lists with metadata filters including age rating and release year, all/any matching, saved filters, reading history, a 90-day pages-read heatmap, dashboard search access on larger layouts, optional unread-cover blur, and batch read-status updates from series pages.
